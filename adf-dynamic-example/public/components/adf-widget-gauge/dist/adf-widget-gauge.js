(function (window) {
 ...
 var GaugeData = function() {};
  ...
  //window.GaugeData = GaugeData;
   ...
   angular.module("adf.widget.gauge").run(["$templateCache", function ($templateCache) { $templateCache.put("{widgetsPath}/gauge/src/view.html", "<div class=\"panel panel-dashboard\"><div class=\"panel-heading\"><div class=\"row\"><div class=\"col-xs-12 text-center\"><div class=\"controls left\"><i class=\"ion ion-more\"></i></div><div class=\"controls right\"><a class=\"remove\"><i class=\"ion ion-minus-round\"></i></a></div><div class=\"center\">{{Metric.value}}</div></div></div></div><div class=\"panel-body\">   <div class=epoch-theme> <epoch-gauge gauge-value=datas gauge-stream=gaugeDatas  chart-height=\"100\" chart-width=\"140\" style=\"display:inline-block;\" chart-margins=\"{ top: 50, right: 30, bottom: 100, left: 40 }\"></epoch-gauge></div> <a href=\"#\"><span>View Details</span></a><div class=\"clearfix\"></div></div></div>"); 
